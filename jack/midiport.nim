...
proc jack_midi_max_event_size*(port_buffer: pointer): csize_t {.importc.}
...
proc jack_midi_event_reserve*(port_buffer: pointer; time: jack_nframes;
                             data_size: csize_t): ptr JackMidiData {.importc.}
...
proc jack_midi_event_write*(port_buffer: pointer; time: jack_nframes;
                           data: ptr JackMidiData; data_size: csize_t): cint {.importc.}
